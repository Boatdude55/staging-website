...
/*  var uri_ = goog.array.map(uris, function (elem, index, arr) {
...
goog.module.ModuleInfo.prototype.getUris = function() {
  ...
  return this.uris_;
  /*if (typeof this.uris_ === 'object') {
    return goog.array.map(this.uris_, function (value, index, array) {
      console.log(value, index, array);
      return goog.html.TrustedResourceUrl.fromConstant(value);
    });
  }else {
    console.log(this.uris_.join());
    goog.string.Const.from(this.uris_.join() + "");
    return [goog.html.TrustedResourceUrl.fromConstant(goog.string.Const.from(this.uris_.join() + ""))];
  }*/
};
